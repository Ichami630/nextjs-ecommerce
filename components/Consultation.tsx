...
function Consultation() {
  ...
  return (
    ...
    >
        <div className="absoulte bg-black bg-opacity-85 flex flex-col text-white p-4 space-y-6 pl-8">
            <h1 className="text-3xl lg:text-4xl font-extrabold w-2/3 lg:w-1/3 flex-wrap">Need Expert Auto Advice? we are Here to Help!</h1>
