        ...
        <ul className="flex flex-col space-y-4 mt-4">
          ...
          {productOpen && (
            <div className="ml-4 flex flex-col space-y-2">
              ...
              <li>
                <Link href="/admin/products/all" onClick={() => { if (isOpen) toggleSidebar(); }}
                  className={`hover:text-primary ${pathname === "/admin/allproducts/all" ? "text-primary font-bold" : ""}`}>
          ...
          <li>
            <Link href="/admin/info" onClick={() => { if (isOpen) toggleSidebar(); }}
              className={`flex flex-row space-x-3 items-center ${pathname === "/admin/info" ? "text-primary font-bold" : "hover:text-primary"}`}>
              <Globe size={20} />
