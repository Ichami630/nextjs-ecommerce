    ...
    <div className="flex flex-col space-y-10">
        <div className="flex p-4 flex-col space-y-4 shadow-md bg-white">
            <div className="flex flex-row space-x-2 items-center">
                ...
                <Link title='new category' href="/admin/categories" className='border-2 bg-gray-400 p-1'><Plus size={14} /></Link>
            </div>
            <form action="" className="mt-4">
                ...
                <button type="submit" className="p-2 font-bold bg-primary text-black hover:bg-black hover:text-white rounded-md mt-4">{isEditing ? "Update category": "Save category"}</button>
            </form>
        </div>
        {/*existing categories */}
        <div className="flex flex-col shadow-md p-4 space-y-4 bg-white overflow-auto">
